            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="overflow: hidden;">
                <tr>
                    <td style="text-align: center;">
                        <!-- Logo Image -->
                        <img src="{{config('app.url')}}/logo.png" alt="Logo" width="120" style="display: block; margin: 0 auto;">

                        <h1 style="color:#344054; font-size: 24px; line-height: 31.2px; font-weight: 700;">You’re Almost There!</h1>
                        <p style="color:#344054; font-size: 22px; line-height: 28.6px; font-weight: 400; margin-bottom: 90px;">You have been added as a user to Edmart application, you can follow the registration process. </p>
