    ...
    <tr>
        <td align="center">
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="overflow: hidden;">
                ...
                <tr>
                    <td style="text-align: center;">
                        <p style="color: #344054; font-size: 16px; line-height: 20.8px; font-weight: 400; margin-top: 90px;">If you did not request to reset password, you can safely ignore this email.</p>
                    </td>
                </tr>
            </table>
        </td>
